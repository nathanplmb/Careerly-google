...
import { d as s, t as c } from "./AppShell-Cmck22UZ.js";
import { t as l } from "./AiContextCard-W22gSVRA.js";
import { a as u, i as d, n as f, r as p, t as m } from "./select-DhJ8LJYr.js";
import { At as h, It as g, S as _, zt as v } from "./index-C957XaZb.js";
import { t as y } from "./useProfil-DaZvyt2K.js";
import { t as b } from "./useCandidatures-kGyisxTi.js";
import { i as x, l as S, r as C } from "./match-run-DGcCutem.js";
import { r as w } from "./redaction.functions-CksB_VeB.js";
var T = e(n()),
  E = t();
function D({ titre: e, texte: t }) {
  return t
    ? (0, E.jsxs)(`div`, {
              ...
              (0, E.jsxs)(o, {
                ...
                onClick: () => {
                  (navigator.clipboard.writeText(t),
                    i.success(`Copié dans le presse-papiers.`));
                },
                className: `h-7 text-xs`,
                children: [(0, E.jsx)(g, { className: `size-3.5` }), ` Copier`],
              }),
            ],
          }),
          (0, E.jsx)(`p`, {
...
function O() {
  let { user: e, authLoading: t, items: n } = b(),
    g = y(e),
    [O, k] = (0, T.useState)(`aucune`),
    [A, j] = (0, T.useState)(``),
    [M, N] = (0, T.useState)(!1),
  ...
  return (0, E.jsx)(c, {
    ...
    headerExtra: (0, E.jsx)(o, {
      ...
      children: (0, E.jsxs)(a, {
        to: `/assistant`,
        children: [
          (0, E.jsx)(v, { className: `size-3.5` }),
          (0, E.jsx)(`span`, { children: `Retour AI Hub` }),
        ],
      }),
    }),
    actions: t
      ? (0, E.jsx)(h, { className: `size-5 animate-spin opacity-70` })
      : null,
              ...
              children: [
                    ...
                    (0, E.jsxs)(m, {
                      ...
                      children: [
                        (0, E.jsx)(d, {
                          ...
                          children: (0, E.jsx)(u, {
                            placeholder: `Général (sans offre spécifique)`,
                          }),
                        }),
                        (0, E.jsxs)(f, {
                          children: [
                ...
                (0, E.jsx)(o, {
                  onClick: async () => {
                    ...
                    try {
                      ...
                      (F({
                        ...
                        messageSuivi: t.messageSuivi ?? ``,
                        accrocheProfil: t.accrocheProfil ?? ``,
                        conseils: t.conseils ?? [],
                      }),
                        i.success(`Messages LinkedIn générés !`));
                    } catch (e) {
                      i.error(S(e));
                    } finally {
                      N(!1);
                  ...
                  children: M
                    ? (0, E.jsxs)(E.Fragment, {
                        children: [
                          (0, E.jsx)(h, { className: `size-4 animate-spin` }),
                          (0, E.jsx)(`span`, {
                            children: `Rédaction en cours...`,
                          }),
                        ],
                      })
                    : (0, E.jsxs)(E.Fragment, {
                        children: [
                          (0, E.jsx)(r, { className: `size-4` }),
                          (0, E.jsx)(`span`, {
                            children: `Générer mes messages LinkedIn`,
                          }),
                        ],
                      }),
                }),
                ...
                ? (0, E.jsxs)(E.Fragment, {
                    children: [
                      ...
                      (0, E.jsx)(D, {
                        ...
                        texte: P.messageSuivi,
                      }),
                      (0, E.jsx)(D, {
                        titre: `Accroche pour votre profil LinkedIn`,
                        texte: P.accrocheProfil,
                      }),
                      P.conseils.length > 0 &&
                        (0, E.jsxs)(`div`, {
