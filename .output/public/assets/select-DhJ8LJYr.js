...
import { a as r, c as i } from "./Logo-BzB7YJf1.js";
import { a, i as o, n as s } from "./button-Fem7RhN8.js";
import { p as c } from "./AppShell-Cmck22UZ.js";
import {
  Rt as l,
  _ as u,
  b as d,
...
import { n as w, t as T } from "./dist-Cgt23J8B.js";
var E = r(`chevron-up`, [[`path`, { d: `m18 15-6-6-6 6`, key: `153udz` }]]),
  D = e(n(), 1),
  O = e(i(), 1),
        ...
        async fn(t) {
          ...
          (b != null && b.enabled.x && (C = _),
            ...
            x &&
              !u &&
              (d
                ? (C = f - 2 * P(c.left, c.right))
                : (S = p - 2 * P(c.top, c.bottom))),
...
var Bt = (e) => {
  ...
  Yt = (e, t) => Jt(e, `name`, { value: t, configurable: !0 });
function Xt(e) {
...
var Y = t(),
  ...
  X = (e, t) => Zt(e, `name`, { value: t, configurable: !0 }),
  Qt = `Popper`,
  [$t, en] = d(Qt),
  [tn, nn] = $t(Qt),
  rn = X((e) => {
  ...
  on = D.forwardRef(
    X(function (e, t) {
      ...
      let f = o.placementState && pn(o.placementState),
        p = f?.[0],
        m = f?.[1];
      return r
        ? null
  ...
  un = D.forwardRef(
    X(function (e, t) {
      let {
        ...
        N = M.length > 0,
        P = { padding: j, boundary: M.filter(dn), altBoundary: N },
        {
          refs: F,
          floatingStyles: I,
          placement: L,
          ...
          whileElementsMounted: X(
            (...e) => Tt(...e, { animationFrame: h === `always` }),
            `whileElementsMounted`,
          ),
          elements: { reference: v.anchor },
          middleware: [
            Vt({ mainAxis: i + k, alignmentAxis: s }),
            l &&
              Ht({
                mainAxis: !0,
                crossAxis: !1,
                limiter: f === `partial` ? Ut() : void 0,
                ...P,
              }),
            l && Wt({ ...P }),
            Gt({
            ...
            w && qt({ element: w, padding: c }),
            fn({ arrowWidth: O, arrowHeight: k }),
            p &&
              Kt({
                strategy: `referenceHidden`,
                ...P,
                boundary: N ? P.boundary : void 0,
              }),
          ],
        }),
        z = v.setPlacementState;
      C(
        () => (
          z(L),
          () => {
      ...
      return (
        ...
        (0, Y.jsx)(`div`, {
          ...
          style: {
            ...I,
            transform: ee ? I.transform : `translate(0, -200%)`,
          ...
          children: (0, Y.jsx)(cn, {
            ...
            children: (0, Y.jsx)(x.div, {
              ...
              style: {
                ..._.style,
                animation: ee ? _.style?.animation : `none`,
              },
            }),
          }),
        })
...
X(pn, `getSideAndAlignFromPlacement`);
var mn = rn,
  hn = on,
  gn = un,
  _n = Object.defineProperty,
  vn = (e, t) => _n(e, `name`, { value: t, configurable: !0 });
function yn(e) {
...
var bn = Object.freeze({
  ...
  Z = (e, t) => xn(e, `name`, { value: t, configurable: !0 }),
  Sn = [` `, `Enter`, `ArrowUp`, `ArrowDown`],
  Cn = [` `, `Enter`],
  wn = `Select`,
  [Tn, En, Dn] = w(wn),
  [On, kn] = d(wn, [Dn, en]),
...
function Pn(e) {
  let {
    ...
    [C, w] = D.useState(!1),
    E = T(l),
    [O, k] = u({ prop: r, defaultProp: i ?? !1, onChange: a, caller: wn }),
    [A, j] = u({ prop: o, defaultProp: s, onChange: c, caller: wn }),
    M = D.useRef(null),
    N = D.useRef(A);
  D.useEffect(() => {
...
var Fn = Z((e) => {
    ...
    return (0, Y.jsx)(Pn, {
      ...
      internal_do_not_use_render: ({ isFormControl: e }) =>
        (0, Y.jsxs)(Y.Fragment, {
          children: [n, e ? (0, Y.jsx)(Sr, { __scopeSelect: t }) : null],
        }),
    });
  }, `Select`),
  In = `SelectTrigger`,
    ...
    Z(function (e, t) {
      ...
      return (0, Y.jsx)(hn, {
        ...
        children: (0, Y.jsx)(x.button, {
          ...
          "data-placeholder": wr(s.value) ? `` : void 0,
          ...i,
          ref: l,
  ...
  zn = D.forwardRef(
    Z(function (e, t) {
      let {
        ...
        d = o !== void 0,
        f = a(t, l.onValueNodeChange);
      C(() => {
        u(d);
      }, [u, d]);
      let p = wr(l.value);
      return (0, Y.jsx)(x.span, {
        ...c,
        asChild: !p && c.asChild,
        ref: f,
  ...
  [Vn, Hn] = On(`SelectPortal`, { forceMount: void 0 }),
  Un = Z((e) => {
    let { __scopeSelect: t, forceMount: n, ...r } = e;
    return (0, Y.jsx)(Vn, {
      scope: e.__scopeSelect,
      forceMount: n,
      children: (0, Y.jsx)(v, { asChild: !0, ...r }),
    });
  }, `SelectPortal`),
  Wn = `SelectContent`,
  Gn = D.forwardRef(
    Z(function (e, t) {
      let n = Hn(Wn, e.__scopeSelect),
        { forceMount: r = n.forceMount, ...i } = e,
        a = Q(Wn, e.__scopeSelect),
        [o, s] = D.useState();
      return (
        C(() => {
  ...
  $ = 10,
  [qn, Jn] = On(Wn),
  Yn = o(`SelectContent.RemoveScroll`),
  Xn = D.forwardRef(
    Z(function (e, t) {
  ...
  Zn = D.forwardRef(
    Z(function (e, t) {
      let { __scopeSelect: n, onPlaced: r, ...i } = e,
        ...
        }, [p, o.trigger, o.valueNode, c, u, g, _, v, o.dir, r]);
      C(() => b(), [b]);
      let [S, w] = D.useState();
      C(() => {
  ...
  [rr, ir] = On(`SelectGroup`),
  ar = `SelectLabel`,
  or = D.forwardRef(
    Z(function (e, t) {
      let { __scopeSelect: n, ...r } = e,
        i = ir(ar, n);
      return (0, Y.jsx)(x.div, { id: i.id, ...r, ref: t });
    }, `SelectLabel`),
  ),
  sr = `SelectItem`,
  [cr, lr] = On(sr),
      ...
      return (0, Y.jsx)(cr, {
        ...
        children: (0, Y.jsx)(Tn.ItemSlot, {
          ...
          children: (0, Y.jsx)(x.div, {
            ...
            ...s,
            ref: _,
            onFocus: S(s.onFocus, () => h(!0)),
            onBlur: S(s.onBlur, () => h(!1)),
            onClick: S(s.onClick, () => {
              y.current !== `mouse` && C();
            }),
            onPointerUp: S(s.onPointerUp, () => {
              y.current === `mouse` && C();
            }),
            onPointerDown: S(s.onPointerDown, (e) => {
              y.current = e.pointerType;
            }),
            onPointerMove: S(s.onPointerMove, (e) => {
              ((y.current = e.pointerType),
                i
                  ? l.onItemLeave?.()
                  : y.current === `mouse` &&
            ...
            onPointerLeave: S(s.onPointerLeave, (e) => {
  ...
  fr = D.forwardRef(
    Z(function (e, t) {
      let { __scopeSelect: n, className: r, style: i, ...o } = e,
        s = Q(dr, n),
        c = Jn(dr, n),
        l = lr(dr, n),
        u = Nn(dr, n),
        [d, f] = D.useState(null),
        p = m((e) => c.itemTextRefCallback?.(e, l.value, l.disabled)),
        h = a(t, f, l.onItemTextChange, p),
        g = d?.textContent,
        _ = D.useMemo(
          () =>
            (0, Y.jsx)(
      ...
      return (
        ...
        (0, Y.jsxs)(Y.Fragment, {
          children: [
            (0, Y.jsx)(x.span, { id: l.textId, ...o, ref: h }),
            l.isSelected &&
            s.valueNode &&
            !s.valueNodeHasChildren &&
            !wr(s.value)
              ? O.createPortal(o.children, s.valueNode)
              : null,
          ],
        })
      );
  ...
  pr = `SelectItemIndicator`,
  mr = D.forwardRef(
    Z(function (e, t) {
      let { __scopeSelect: n, ...r } = e;
      return lr(pr, n).isSelected
        ? (0, Y.jsx)(x.span, { "aria-hidden": !0, ...r, ref: t })
        : null;
    }, `SelectItemIndicator`),
  ),
  hr = `SelectScrollUpButton`,
  gr = D.forwardRef(
    Z(function (e, t) {
      let n = Jn(hr, e.__scopeSelect),
        r = er(hr, e.__scopeSelect),
        [i, o] = D.useState(!1),
        s = a(t, r.onScrollButtonChange);
      return (
        C(() => {
  ...
  _r = `SelectScrollDownButton`,
  vr = D.forwardRef(
    Z(function (e, t) {
      let n = Jn(_r, e.__scopeSelect),
        r = er(_r, e.__scopeSelect),
        [i, o] = D.useState(!1),
        s = a(t, r.onScrollButtonChange);
      return (
        C(() => {
  ...
  br = D.forwardRef(
    Z(function (e, t) {
      let { __scopeSelect: n, ...r } = e;
      return (0, Y.jsx)(x.div, { "aria-hidden": !0, ...r, ref: t });
    }, `SelectSeparator`),
  ),
  xr = `SelectBubbleInput`,
  Sr = D.forwardRef(
      ...
      return (
        ...
        (0, Y.jsxs)(
          x.select,
          {
            ...
            defaultValue: g,
            children: [
              wr(i) && !v ? (0, Y.jsx)(`option`, { value: `` }) : null,
              Array.from(f),
            ],
          },
          p,
...
var Or = Fn,
  kr = zn,
  Ar = D.forwardRef(({ className: e, children: t, ...n }, r) =>
    (0, Y.jsxs)(Ln, {
      ref: r,
      className: s(
      ...
      children: [
        ...
        (0, Y.jsx)(Bn, {
          asChild: !0,
          children: (0, Y.jsx)(c, { className: `h-4 w-4 opacity-50` }),
        }),
      ],
    }),
  );
Ar.displayName = Ln.displayName;
var jr = D.forwardRef(({ className: e, ...t }, n) =>
  (0, Y.jsx)(gr, {
    ref: n,
    className: s(`flex cursor-default items-center justify-center py-1`, e),
    ...t,
    children: (0, Y.jsx)(E, { className: `h-4 w-4` }),
  }),
);
jr.displayName = gr.displayName;
var Mr = D.forwardRef(({ className: e, ...t }, n) =>
  (0, Y.jsx)(vr, {
    ref: n,
    className: s(`flex cursor-default items-center justify-center py-1`, e),
    ...t,
...
Mr.displayName = vr.displayName;
var Nr = D.forwardRef(
  ({ className: e, children: t, position: n = `popper`, ...r }, i) =>
    (0, Y.jsx)(Un, {
      children: (0, Y.jsxs)(Gn, {
        ref: i,
        className: s(
...
Nr.displayName = Gn.displayName;
var Pr = D.forwardRef(({ className: e, ...t }, n) =>
  (0, Y.jsx)(or, {
    ref: n,
    className: s(`px-2 py-1.5 text-sm font-semibold`, e),
    ...t,
  }),
);
Pr.displayName = or.displayName;
var Fr = D.forwardRef(({ className: e, children: t, ...n }, r) =>
  (0, Y.jsxs)(ur, {
    ref: r,
    className: s(
    ...
    children: [
      (0, Y.jsx)(`span`, {
        ...
        children: (0, Y.jsx)(mr, {
          children: (0, Y.jsx)(l, { className: `h-4 w-4` }),
        }),
      }),
      (0, Y.jsx)(fr, { children: t }),
    ],
  }),
);
Fr.displayName = ur.displayName;
var Ir = D.forwardRef(({ className: e, ...t }, n) =>
  (0, Y.jsx)(br, { ref: n, className: s(`-mx-1 my-1 h-px bg-muted`, e), ...t }),
);
Ir.displayName = br.displayName;
export {
  kr as a,
  mn as c,
  E as d,
