...
function b(e, t, n) {
  ...
  if (_(e) && _(t)) {
    ...
    if (n?.partial) {
      for (let i in t)
        if ((!r || t[i] !== void 0) && !b(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t)
      if ((!r || t[o] !== void 0) && (a++, a > i || !b(e[o], t[o], n)))
        return !1;
    return i === a;
  }
  return !1;
...
function ne(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    i;
  for (; (i = t.exec(e)) !== null;)
    ((r += w(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += w(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function ie(e, t, n, r, i, a, o, s) {
  ...
  if (n.children) for (let r of n.children) ie(e, t, r, c, i, a, o, s);
}
function ae(e, t) {
...
function I(e, t) {
  let n = P(`/`),
    r = new Uint16Array(6),
    i = [];
  for (let t of e) ie(!1, r, t, 1, n, 0, i);
  for (let e of i) e.sort(ae);
...
function se(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = P(`/`)),
      ie(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function L(e, t, n = !1) {
  ...
  let a;
  try {
    a = z(e, t.segmentTree, n);
  } catch (e) {
    if (e instanceof URIError) a = null;
    else throw e;
  }
  return (a && (a.branch = V(a.route)), t.matchCache.set(r, a), a);
}
function R(e) {
...
function ce(e, t = !1, n) {
  let r = P(e.fullPath),
    ...
    c = 0;
  ie(t, i, e, 1, r, 0, a, (e) => {
    if ((n?.(e, c), e.id in o && A(), (o[e.id] = e), c !== 0 && e.path)) {
      let t = R(e.fullPath);
      (!s[t] || e.fullPath.endsWith(`/`)) && (s[t] = e);
    }
    c++;
  });
  for (let e of a) e.sort(ae);
  return {
    processedTree: {
      segmentTree: r,
      singleCache: j(1e3),
...
function ue(e, t, n, r) {
  ...
  for (; s.length;) {
    ...
    if (i.kind === 2 && i.route && !H(u, n)) continue;
    if (i.parse) {
      if (!pe(e, t, n)) continue;
      ((g = n.rawParams), (h = n.extract));
    }
    r && i.route && i.kind !== M && H(l, n) && (l = n);
    let _ = c === o;
    if (
      _ &&
      (i.route && (!a || i.kind === M || i.kind === 2) && H(u, n) && (u = n),
    ...
    if (_ && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (pe(e, t, n) || (r = !1)), r)) {
        if (!p && !m && !d && fe(f, o)) return n;
        H(u, n) && (u = n);
      }
    }
    if (i.wildcard)
      for (let e = i.wildcard.length - 1; e >= 0; e--) {
        ...
        if (!(
          ...
          if (a) {
            if (_) continue;
            let e = t.slice(c).join(`/`),
              i = e.slice(-a.length);
            if (
              (n.caseSensitive ? i : i.toLowerCase()) !== a ||
...
function me(e) {
  return U(e.filter((e) => e !== void 0).join(`/`));
}
function U(e) {
...
function be({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  if ((t.includes(`//`) && (t = U(t)), t.startsWith(`/`)))
  ...
  o.length > 1 &&
    (c(o) === `` ? n === `never` && o.pop() : n === `always` && o.push(``));
  let s = o.join(`/`),
    l = (i ? U(s) : s) || `/`;
  return (a && r && r.set(a, l), l);
}
function xe(e) {
...
function Ce({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
  if (!e || e === `/`)
...
var Te = `Error preloading route! ☝️`,
  W = e(n(), 1),
  Ee = W.use,
  De = W.useLayoutEffect;
function Oe(e, t, n) {
  W.useEffect(() => {
...
function je(e, t) {
  ...
  return (r) => {
    ...
    return (e?.structuralSharing ?? t.options.defaultStructuralSharing)
      ? (n.current = h(n.current, i))
      : i;
  };
}
function Me(e) {
  let t = r(),
    n = W.useContext(e.from ? i : a),
    o = e.from ?? n,
    c = t.stores.getMatchStore(o),
    l = je(e, t),
    u = s(c, (e) => (e ? l(e) : Ae));
  if (u !== Ae) return u;
  (e.shouldThrow ?? !0) && A();
...
function Pe(e) {
  let t = W.useRef(e);
  return (
    b(t.current, e, { ignoreUndefined: !1 }) || (t.current = e),
    t.current
  );
}
function Fe(e, t) {
...
function Ie(e, t, n) {
  if (e?.external) return E(e.href, n) ? void 0 : e.href;
  if (!qe(t) && typeof t == `string` && t.indexOf(`:`) !== -1)
    try {
      return (new URL(t), E(t, n) ? void 0 : t);
    } catch {}
}
function Le(e, t, n, r, i, a) {
  if (a) return !1;
  if (n?.exact) {
    if (!ye(e.pathname, t.pathname, r)) return !1;
  } else {
    let n = ve(e.pathname, r),
      i = ve(t.pathname, r);
...
function Re(e, t) {
  let n = r(),
    ...
    ce = W.useCallback(
      (e) => {
        let t = n.buildLocation({ _fromLocation: e, ...R }),
          r = Ke(
          ...
          i = Ie(r, d, n.protocolAllowlist);
        return [r?.href, i, Le(e, t, L, n.basepath, I, i !== void 0)];
      },
      [L, S, I, R, n, d],
    ),
    [z, B, V] = s(n.stores.location, ce, Fe),
    le = V ? (l(a, {}) ?? Be) : ze,
    ue = V ? ze : (l(c, {}) ?? ze),
    de = [w, le.className, ue.className].filter(Boolean).join(` `),
    fe = (C || le.style || ue.style) && { ...C, ...le.style, ...ue.style },
    pe = W.useRef(!1),
    H = e.reloadDocument || B || S ? !1 : (f ?? n.options.defaultPreload),
    me = p ?? n.options.defaultPreloadDelay ?? 0,
    U = W.useCallback(() => {
      n.preloadRoute(R).catch((e) => {
        (console.warn(e), console.warn(Te));
      });
    }, [n, R]),
    he = W.useCallback(
      (e) => {
        ...
        if (!(e.isIntersecting ?? H === `intent`)) {
          e.isIntersecting === !1 && We(i);
          return;
        }
        if (!me) {
          U();
  ...
  (Oe(i, he, H !== `viewport`),
    W.useEffect(() => {
      pe.current || (H === `render` && (U(), (pe.current = !0)));
    }, [U, H]));
  let ge = (e) => {
  ...
  return {
    ...
    onBlur: Ge([E, ve]),
    onFocus: Ge([ee, he]),
    onMouseEnter: Ge([D, he]),
    onMouseLeave: Ge([te, ve]),
    onTouchStart: Ge([ne, _e]),
    disabled: !!S,
    target: x,
    ...(fe && { style: fe }),
    ...(de && { className: de }),
...
var ze = {},
  Be = { className: `active` },
  Ve = { role: `link`, "aria-disabled": !0 },
  He = { "data-status": `active`, "aria-current": `page` },
  Ue = new WeakMap(),
  We = (e) => {
    (clearTimeout(Ue.get(e)), Ue.delete(e));
  },
  Ge = (e) => (t) => {
    for (let n of e)
      if (n) {
...
var Je = W.forwardRef((e, t) => {
    ...
    if (!n) {
      let { disabled: e, ...t } = a;
      return W.createElement(`a`, t, o);
    }
    return W.createElement(n, a, o);
  }),
  Ye = Object.defineProperty,
  Xe = (e, t) => Ye(e, `name`, { value: t, configurable: !0 });
function Ze(e, t) {
...
Xe(Qe, `composeRefs`);
function $e(...e) {
  return W.useCallback(Qe(...e), e);
}
Xe($e, `useComposedRefs`);
var et = Object.defineProperty,
  G = (e, t) => et(e, `name`, { value: t, configurable: !0 });
function tt(e) {
  let t = W.forwardRef((t, n) => {
    let { children: r, ...i } = t,
      ...
      o = !1,
      s = [];
    (ut(r) && typeof mt == `function` && (r = mt(r._payload)),
      W.Children.forEach(r, (e) => {
        if (ct(e)) {
          o = !0;
          let t = e,
            n = `child` in t.props ? t.props.child : t.props.children;
          (ut(n) && typeof mt == `function` && (n = mt(n._payload)),
            (a = at(t, n)),
    ...
    let c = a ? st(a) : void 0,
      l = $e(n, c);
    if (!a) {
      if (r || r === 0) throw Error(o ? pt(e) : ft(e));
      return r;
    }
    let u = ot(i, a.props ?? {});
...
G(tt, `createSlot`);
var nt = tt(`Slot`),
  rt = Symbol.for(`radix.slottable`);
function it(e) {
  let t = G(
    (e) => (`child` in e ? e.children(e.child) : e.children),
    `Slottable`,
  );
  return ((t.displayName = `${e}.Slottable`), (t.__radixId = rt), t);
}
G(it, `createSlottable`);
var at = G((e, t) => {
  if (`child` in e.props) {
    let t = e.props.child;
...
var _t = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  vt = gt,
  yt = (e, t) => (n) => {
    if (t?.variants == null) return vt(e, n?.class, n?.className);
  ...
  Ut = (e) => {
    ...
    if (t) {
      let e = t + Bt,
        n = r;
      r = (t) =>
        t.startsWith(e) ? n(t.slice(e.length)) : Ht(Vt, !1, t, void 0, !0);
    }
    if (n) {
      let e = r;
  ...
  cn = (e) => e.endsWith(`%`) && J(e.slice(0, -1)),
  X = (e) => nn.test(e),
  ln = () => !0,
  un = (e) => rn.test(e) && !an.test(e),
  dn = () => !1,
  fn = (e) => on.test(e),
  pn = (e) => sn.test(e),
  mn = (e) => !Z(e) && !Q(e),
  ...
  Mn = (e) => e === `position` || e === `percentage`,
  Nn = (e) => e === `image` || e === `url`,
  Pn = (e) => e === `length` || e === `size` || e === `bg-size`,
  Fn = (e) => e === `length`,
  In = (e) => e === `number`,
  Ln = (e) => e === `family-name`,
  Rn = (e) => e === `number` || e === `weight`,
  zn = (e) => e === `shadow`,
  Bn = Zt(() => {
    let e = K(`color`),
      t = K(`font`),
      ...
      w = () => [Q, Z, c],
      T = () => [q, `full`, `auto`, ...w()],
      E = () => [Y, `none`, `subgrid`, Q, Z],
      ee = () => [`auto`, { span: [`full`, Y, Q, Z] }, Y, Q, Z],
      D = () => [Y, `auto`, Q, Z],
      te = () => [`auto`, `min`, `max`, `fr`, Q, Z],
      ne = () => [
        `start`,
        `end`,
        `center`,
      ...
      N = () => [e, Q, Z],
      re = () => [...b(), En, xn, { position: [Q, Z] }],
      ie = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      ae = () => [`auto`, `cover`, `contain`, Dn, gn, { size: [Q, Z] }],
      P = () => [cn, wn, _n],
      F = () => [``, `none`, `full`, l, Q, Z],
      I = () => [``, J, wn, _n],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, q, Z, Q, g] }],
        container: [`container`],
        "container-type": [{ "@container": [``, `normal`, `size`, Q, Z] }],
        "container-named": [hn],
        columns: [{ columns: [J, Z, Q, s] }],
        ...
        z: [{ z: [Y, `auto`, Q, Z] }],
        basis: [{ basis: [q, `full`, `auto`, s, ...w()] }],
        "flex-direction": [
          { flex: [`row`, `row-reverse`, `col`, `col-reverse`] },
        ],
        "flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [J, q, `auto`, `initial`, `none`, Z] }],
        grow: [{ grow: [``, J, Q, Z] }],
        shrink: [{ shrink: [``, J, Q, Z] }],
        order: [{ order: [Y, `first`, `last`, `none`, Q, Z] }],
        ...
        "font-size": [{ text: [`base`, n, wn, _n] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, An, yn] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        "line-clamp": [{ "line-clamp": [J, `none`, Q, vn] }],
        leading: [{ leading: [a, ...w()] }],
        ...
        "text-decoration-thickness": [
          { decoration: [J, `from-font`, `auto`, Q, _n] },
        ],
        "text-decoration-color": [{ decoration: N() }],
        "underline-offset": [{ "underline-offset": [J, `auto`, Q, Z] }],
        "text-transform": [
          `uppercase`,
          `lowercase`,
          `capitalize`,
        ...
        "outline-offset": [{ "outline-offset": [J, Q, Z] }],
        "outline-w": [{ outline: [``, J, wn, _n] }],
        "outline-color": [{ outline: N() }],
        shadow: [{ shadow: [``, `none`, u, kn, Cn] }],
        "shadow-color": [{ shadow: N() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, kn, Cn] }],
        "inset-shadow-color": [{ "inset-shadow": N() }],
        "ring-w": [{ ring: I() }],
        "ring-w-inset": [`ring-inset`],
        "ring-color": [{ ring: N() }],
        "ring-offset-w": [{ "ring-offset": [J, _n] }],
        "ring-offset-color": [{ "ring-offset": N() }],
        "inset-ring-w": [{ "inset-ring": I() }],
        "inset-ring-color": [{ "inset-ring": N() }],
        "text-shadow": [{ "text-shadow": [`none`, f, kn, Cn] }],
        "text-shadow-color": [{ "text-shadow": N() }],
        opacity: [{ opacity: [J, Q, Z] }],
        "mix-blend": [
        ...
        blur: [{ blur: R() }],
        brightness: [{ brightness: [J, Q, Z] }],
        contrast: [{ contrast: [J, Q, Z] }],
        "drop-shadow": [{ "drop-shadow": [``, `none`, p, kn, Cn] }],
        "drop-shadow-color": [{ "drop-shadow": N() }],
        grayscale: [{ grayscale: [``, J, Q, Z] }],
        "hue-rotate": [{ "hue-rotate": [J, Q, Z] }],
        invert: [{ invert: [``, J, Q, Z] }],
        saturate: [{ saturate: [J, Q, Z] }],
        sepia: [{ sepia: [``, J, Q, Z] }],
        "backdrop-filter": [{ "backdrop-filter": [``, `none`, Q, Z] }],
        "backdrop-blur": [{ "backdrop-blur": R() }],
        "backdrop-brightness": [{ "backdrop-brightness": [J, Q, Z] }],
        "backdrop-contrast": [{ "backdrop-contrast": [J, Q, Z] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": [``, J, Q, Z] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [J, Q, Z] }],
        "backdrop-invert": [{ "backdrop-invert": [``, J, Q, Z] }],
        "backdrop-opacity": [{ "backdrop-opacity": [J, Q, Z] }],
        "backdrop-saturate": [{ "backdrop-saturate": [J, Q, Z] }],
        "backdrop-sepia": [{ "backdrop-sepia": [``, J, Q, Z] }],
        ...
        duration: [{ duration: [J, `initial`, Q, Z] }],
...
var Hn = yt(
  ...
  Un = W.forwardRef(
    ({ className: e, variant: t, size: n, asChild: r = !1, ...i }, a) =>
      (0, Ne.jsx)(r ? nt : `button`, {
        className: Vn(Hn({ variant: t, size: n, className: e })),
        ref: a,
        ...i,
      }),
  );
