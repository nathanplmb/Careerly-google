...
import { l as a, t as o } from "./AppShell-Cmck22UZ.js";
import { t as s } from "./calendar-clock-CoDi51GC.js";
import { t as c } from "./external-link-Hum5k663.js";
import {
  $ as l,
  At as u,
  Y as d,
...
import { t as _ } from "./CandidatureSheet-uNs02hvY.js";
import { t as v } from "./MatchBadge-BBZjHc57.js";
import { t as y } from "./ImportIaDialog-fXGqPxj0.js";
var b = e(n()),
  x = t(),
  S = [
    `var(--primary)`,
...
function C() {
  let { user: e, authLoading: t, items: n, patch: C, save: w } = g(),
    T = h(e),
    [E, D] = (0, b.useState)(null),
    [O, k] = (0, b.useState)(!1),
    [A, j] = (0, b.useState)(!1),
    M = p(),
    N = (0, b.useMemo)(
      () =>
        m.map((e) => ({ statut: e, liste: n.filter((t) => t.statut === e) })),
      [n],
    ),
    P = (0, b.useMemo)(
      () =>
        n
          .filter(
            (e) => e.dateLimite && e.dateLimite >= M && e.dateLimite <= d(M, 7),
          )
          .sort((e, t) => e.dateLimite.localeCompare(t.dateLimite)),
      [n, M],
    ),
    F = (e) => {
      (D(e), k(!0));
  ...
  return (0, x.jsxs)(o, {
    ...
    headerExtra: (0, x.jsxs)(x.Fragment, {
      children: [
        (0, x.jsxs)(i, {
          variant: `secondary`,
          onClick: () => j(!0),
          children: [(0, x.jsx)(r, {}), ` Analyser une offre (IA)`],
        }),
        (0, x.jsxs)(i, {
          onClick: () => {
            (D(f()), k(!0));
          },
          children: [(0, x.jsx)(a, {}), ` Ajouter une opportunité`],
        }),
      ],
    }),
    actions: t
      ? (0, x.jsx)(u, { className: `size-5 animate-spin opacity-70` })
      : null,
    children: [
      P.length > 0 &&
        (0, x.jsxs)(`div`, {
          ...
          children: [
            (0, x.jsxs)(`p`, {
              ...
              children: [
                (0, x.jsx)(s, { className: `size-4 text-primary` }),
              ...
              children: P.map((e) =>
                (0, x.jsxs)(
                  `button`,
                  {
                    ...
                    children: [e.entreprise, ` — `, l(e.dateLimite)],
                  },
                  e.id,
                ),
              ),
      ...
      (0, x.jsx)(`div`, {
        ...
        children: N.map(({ statut: e, liste: t }, n) =>
          (0, x.jsxs)(
            `section`,
            {
                    ...
                    `article`,
                    {
                      ...
                      children: [
                        ...
                        (0, x.jsxs)(`div`, {
                          ...
                          children: [
                            t.match && (0, x.jsx)(v, { match: t.match }),
                            t.lieu &&
                              (0, x.jsx)(`span`, {
                            ...
                            t.dateLimite &&
                              (0, x.jsxs)(`span`, {
                                ...
                                children: [`Limite `, l(t.dateLimite)],
                              }),
                            t.lien &&
                              (0, x.jsxs)(`a`, {
                                href: t.lien,
