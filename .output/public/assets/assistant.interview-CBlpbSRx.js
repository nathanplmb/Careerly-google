...
import { o as s, t as c } from "./AppShell-Cmck22UZ.js";
import { t as l } from "./AiContextCard-W22gSVRA.js";
import { a as u, i as d, n as f, r as p, t as m } from "./select-DhJ8LJYr.js";
import { t as h } from "./message-square-quote-CIEHMFQ_.js";
import { t as g } from "./triangle-alert-Eve6ocHQ.js";
import { At as _, S as v, zt as y } from "./index-C957XaZb.js";
import { t as b } from "./useProfil-DaZvyt2K.js";
import { t as x } from "./useCandidatures-kGyisxTi.js";
import { i as S, l as C, r as w } from "./match-run-DGcCutem.js";
import { t as T } from "./redaction.functions-CksB_VeB.js";
import { i as E, n as D, r as O, t as k } from "./accordion-CLo6WRir.js";
var A = e(n()),
  j = t();
function M({ titre: e, items: t, icon: n }) {
  return t.length
    ? (0, j.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, j.jsx)(`ul`, {
            ...
            children: t.map((e, t) => (0, j.jsx)(`li`, { children: e }, t)),
          }),
        ],
      })
    : null;
...
function N() {
  let { user: e, authLoading: t, items: n } = x(),
    N = b(e),
    [P, F] = (0, A.useState)(n[0]?.id ?? `aucune`),
    [I, L] = (0, A.useState)(``),
    [R, z] = (0, A.useState)(!1),
  ...
  return (0, j.jsx)(c, {
    ...
    headerExtra: (0, j.jsx)(o, {
      ...
      children: (0, j.jsxs)(a, {
        to: `/assistant`,
        children: [
          (0, j.jsx)(y, { className: `size-3.5` }),
          (0, j.jsx)(`span`, { children: `Retour AI Hub` }),
        ],
      }),
    }),
    actions: t
      ? (0, j.jsx)(_, { className: `size-5 animate-spin opacity-70` })
      : null,
              ...
              children: [
                ...
                (0, j.jsx)(o, {
                  onClick: async () => {
                    ...
                    try {
                      ...
                      (V({
                        ...
                        argumentsCles: t.argumentsCles ?? [],
                        pointsFaibles: t.pointsFaibles ?? [],
                        questionsARecruteur: t.questionsARecruteur ?? [],
                      }),
                        i.success(`Simulation d'entretien générée !`));
                    } catch (e) {
                      i.error(C(e));
                    } finally {
                      z(!1);
                  ...
                  children: R
                    ? (0, j.jsxs)(j.Fragment, {
                        children: [
                          (0, j.jsx)(_, { className: `size-4 animate-spin` }),
                          (0, j.jsx)(`span`, {
                            children: `Préparation en cours...`,
                          }),
                        ],
                      })
                    : (0, j.jsxs)(j.Fragment, {
                        children: [
                          (0, j.jsx)(r, { className: `size-4` }),
                          (0, j.jsx)(`span`, {
            ...
            (0, j.jsx)(`section`, {
              ...
              children: B
                ...
                : (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsx)(h, {
                        className: `mx-auto size-8 text-muted-foreground/50 mb-2`,
                      }),
                      (0, j.jsx)(`p`, {
