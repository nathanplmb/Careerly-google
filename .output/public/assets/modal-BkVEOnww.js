...
import { n as t } from "./button-Fem7RhN8.js";
import { a as n, c as r, i, r as a, s as o } from "./index-C957XaZb.js";
var s = e(),
  c = {
    sm: `sm:max-w-md`,
    md: `sm:max-w-lg`,
    ...
    children: (0, s.jsxs)(i, {
      ...
      children: [
        (0, s.jsxs)(o, {
          ...
          children: [
            (0, s.jsx)(r, { className: `text-base sm:text-lg`, children: u }),
            d ? (0, s.jsx)(n, { className: `truncate`, children: d }) : null,
          ],
        }),
        (0, s.jsx)(`div`, {
          className: t(`min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-6`, g),
          children: f,
        }),
        p
          ? (0, s.jsx)(`div`, {
