...
import { c as r } from "./useStore-D1ICS8_H.js";
import { n as i } from "./button-Fem7RhN8.js";
var a = e((e) => {
    var t = r();
    function n(e) {
...
var ee = (e) => {
  ...
  g = 1,
  _ = 100,
  v = (e) => (typeof e?.id == `number` || e?.id?.length > 0 ? e.id : g++),
  y = new (class {
    constructor() {
      ((this.subscribe = (e) => (
...
var A = (e) => {
  let {
    ...
    q = s.useMemo(() => c.findIndex((e) => e.toastId === n.id) || 0, [c, n.id]),
    ve = s.useMemo(() => n.closeButton ?? m, [n.closeButton, m]),
    ye = s.useMemo(() => n.duration || x || E, [n.duration, x]),
    J = s.useRef(0),
    Y = s.useRef(0),
    be = s.useRef(0),
    X = s.useRef(null),
    [xe, Se] = S.split(`-`),
    Ce = s.useMemo(
      () => c.reduce((e, t, n) => (n >= q ? e : e + t.height), 0),
      [c, q],
    ),
    we = h(),
    Z = s.useMemo(() => e.swipeDirections ?? k(S), [e.swipeDirections, S]),
    Te = n.invert || t,
    Q = G === `loading`;
  ((Y.current = s.useMemo(() => q * re + Ce, [q, Ce])),
    s.useEffect(() => {
      U.current = ye;
    }, [ye]),
    s.useEffect(() => {
  ...
  function Ee() {
    return D?.loading
      ? s.createElement(
          `div`,
          {
            className: O(T?.loader, n?.classNames?.loader, `sonner-loader`),
            "data-visible": G === `loading`,
          },
          D.loading,
        )
      : s.createElement(te, {
          className: O(T?.loader, n?.classNames?.loader),
          visible: G === `loading`,
        });
  }
  let De = n.icon || D?.[G] || ee(G);
  return s.createElement(
    `li`,
    {
      ...
      style: {
        ...
        "--toasts-before": l,
        "--z-index": u.length - l,
        "--offset": `${F ? le : Y.current}px`,
        "--initial-height": w ? `auto` : `${ue}px`,
        ...g,
        ...n.style,
      },
      onDragEnd: () => {
        (R(!1), j(null), (X.current = null));
      },
      onPointerDown: (e) => {
        e.button !== 2 &&
          (Q ||
            ...
            e.target.tagName !== `BUTTON` &&
              (R(!0), (X.current = { x: e.clientX, y: e.clientY }))));
      },
      onPointerUp: () => {
        if (z || !K) return;
        X.current = null;
        ...
        if (
          (A === `x`
            ? Z.includes(e > 0 ? `right` : `left`)
            : Z.includes(t > 0 ? `bottom` : `top`)) &&
          (Math.abs(i) >= ae || a > 0.11)
        ) {
          (H(Y.current),
            n.onDismiss == null || n.onDismiss.call(n, n),
            M(A === `x` ? (e > 0 ? `right` : `left`) : t > 0 ? `down` : `up`),
            $(),
            B(!0));
          return;
        }
      ...
      onPointerMove: (e) => {
        var t, n;
        if (!X.current || !K || window.getSelection()?.toString().length > 0)
          return;
        let r = e.clientY - X.current.y,
          i = e.clientX - X.current.x;
        !A &&
          (Math.abs(i) > 1 || Math.abs(r) > 1) &&
          j(Math.abs(i) > Math.abs(r) ? `x` : `y`);
        let a = { x: 0, y: 0 },
          o = (e) => 1 / (1.5 + Math.abs(e) / 20);
        if (A === `y`) {
          if (Z.includes(`top`) || Z.includes(`bottom`)) {
            if ((Z.includes(`top`) && r < 0) || (Z.includes(`bottom`) && r > 0))
              a.y = r;
            else {
              let e = r * o(r);
        ...
        } else if (A === `x` && (Z.includes(`left`) || Z.includes(`right`))) {
          if ((Z.includes(`left`) && i < 0) || (Z.includes(`right`) && i > 0))
            a.x = i;
          else {
            let e = i * o(i);
        ...
        ((Math.abs(a.x) > 0 || Math.abs(a.y) > 0) && V(!0),
          (t = W.current) == null ||
    ...
    ve && !n.jsx && G !== `loading`
      ? s.createElement(
          `button`,
          {
            ...
            className: O(T?.closeButton, n?.classNames?.closeButton),
          },
          D?.close ?? ne,
        )
      : null,
    (G || n.icon || n.promise) && n.icon !== null && (D?.[G] !== null || n.icon)
      ? s.createElement(
          `div`,
          { "data-icon": ``, className: O(T?.icon, n?.classNames?.icon) },
          G === `loading` ? n.icon || Ee() : n.promise ? Ee() : null,
          G === `loading` ? null : De,
        )
      : null,
    s.createElement(
      `div`,
      { "data-content": ``, className: O(T?.content, n?.classNames?.content) },
      s.createElement(
        `div`,
        { "data-title": ``, className: O(T?.title, n?.classNames?.title) },
      ...
      n.description
        ? s.createElement(
            ...
            {
              "data-description": ``,
              className: O(b, _e, T?.description, n?.classNames?.description),
            },
      ...
      : n.cancel && C(n.cancel)
        ? s.createElement(
            `button`,
            {
              ...
              className: O(T?.cancelButton, n?.classNames?.cancelButton),
            },
            n.cancel.label,
          )
        : null,
    s.isValidElement(n.action)
      ? n.action
      : n.action && C(n.action)
        ? s.createElement(
            `button`,
            {
              ...
              className: O(T?.actionButton, n?.classNames?.actionButton),
            },
            n.action.label,
          )
        : null,
...
var M = s.forwardRef(function (e, t) {
    let {
      ...
      z = s.useCallback((e) => {
        C(
          (t) => (
            t.find((t) => t.id === e.id)?.delete || y.dismiss(e.id),
                ...
                `ol`,
                {
                  ...
                  onBlur: (e) => {
                    R.current &&
                      ...
                      ((R.current = !1),
                      (L.current &&=
                        (L.current.focus({ preventScroll: !0 }), null)));
                  },
                  onFocus: (e) => {
                    (e.target instanceof HTMLElement &&
                      e.target.dataset.dismissible === `false`) ||
                      R.current ||
                      ((R.current = !0), (L.current = e.relatedTarget));
                  },
                  onMouseEnter: () => O(!0),
                  onMouseMove: () => O(!0),
                  onMouseLeave: () => {
  ...
  B = (e, t) => {
    let n = (0, s.forwardRef)(({ className: n, ...r }, i) =>
      (0, s.createElement)(z, {
        ref: i,
        iconNode: t,
        className: N(`lucide-${P(I(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
  ...
  H = n();
function ue({ compact: e = !1, className: t }) {
  return e
    ? (0, H.jsx)(`span`, {
        className: i(`inline-flex items-center`, t),
          ...
          children: [
            (0, H.jsx)(`defs`, {
              children: (0, H.jsxs)(`linearGradient`, {
                ...
                y2: `100%`,
                children: [
                  (0, H.jsx)(`stop`, { offset: `0%`, stopColor: `#a855f7` }),
                  (0, H.jsx)(`stop`, { offset: `50%`, stopColor: `#9333ea` }),
                  (0, H.jsx)(`stop`, { offset: `100%`, stopColor: `#7c3aed` }),
                ],
              }),
            }),
            (0, H.jsxs)(`g`, {
...
export { B as a, o as c, ce as i, le as n, M as o, V as r, S as s, ue as t };
