...
//#region node_modules/.nitro/vite/services/ssr/assets/relance.functions-Cr5vWX3Z.js
var Input = object({
...
var genererRelance = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((data) => Input.parse(data)).handler(genererRelance_createServerFn_handler, async ({ data, context }) => {
	...
	const { genererRelanceIA, MODELE_RELANCE } = await import("./relance.server-MAA6utcU.mjs");
	return {
