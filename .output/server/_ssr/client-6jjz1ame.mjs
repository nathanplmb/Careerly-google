...
//#region node_modules/.nitro/vite/services/ssr/assets/client-6jjz1ame.js
...
function createSupabaseClient() {
	...
	}["VITE_SUPABASE_URL"] || (typeof processModule !== "undefined" ? processModule.env["SUPABASE_URL"] : void 0);
	const SUPABASE_PUBLISHABLE_KEY = {
		...
		"TSS_SERVER_FN_BASE": "/_serverFn/",
		"VITE_SUPABASE_PROJECT_ID": "qthnoiooyawmntqdbqgo"
	}["VITE_SUPABASE_PUBLISHABLE_KEY"] || (typeof processModule !== "undefined" ? processModule.env["SUPABASE_PUBLISHABLE_KEY"] : void 0);
	if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) return createClient("https://placeholder.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.e30.signature", { auth: {
...
function isSupabaseConfigured() {
	...
	return Boolean(SUPABASE_URL && SUPABASE_PUBLISHABLE_KEY && !SUPABASE_URL.includes("placeholder.supabase.co"));
}
var _supabase;
