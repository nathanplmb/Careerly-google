...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-Ca2emXMH.js
var server_Ca2emXMH_exports = /* @__PURE__ */ __exportAll({
	a: () => getServerFnById,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dv4ABfat.mjs");
...
var manifest = {
	"083602d0b411f735d2eebc83b88e78ffbf195fe1ecbd8d102e008b00ba40a90e": {
		...
		importer: () => import("./relance.functions-BiooUQzQ.mjs")
	},
	"1bb0be9313798ba1b18dae0bd81804d89445abd1715cf12be9b75f8d4c676adc": {
		functionName: "trierAvecIa_createServerFn_handler",
		importer: () => import("./tri-ia.functions-CWPkcV8u.mjs")
	},
	...
	"f31cec66ab6270632e857c072556e946de1cb08cff5fad1e7ad30363aeb8101e": {
		...
		importer: () => import("./cv.functions-BkKpQa9V.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-WcHZLW5p.mjs").then((n) => n.t),
		import("./start-1ulq0w_T.mjs"),
...
//#endregion
export { getServerFnById as a, getRequest as i, createCsrfMiddleware as n, server_Ca2emXMH_exports as o, createServerFn as r, createMiddleware as s, TSS_SERVER_FUNCTION as t };
