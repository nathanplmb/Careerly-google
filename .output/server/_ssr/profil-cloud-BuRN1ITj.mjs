...
import { a as getServerFnById, i as TSS_SERVER_FUNCTION, r as createServerFn } from "./server-O3Hnh0sN.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-C1JExzcM.js
...
var cachedFirebaseUser = null;
var cachedSession = null;
var cachedLocalUser = null;
var cachedLoading = true;
...
function initGlobalAuth() {
	...
	if (isFirebaseConfigured()) onAuthStateChanged(auth, (fUser) => {
...
function useSession() {
	...
	const computedUser = (0, import_react.useMemo)(() => {
		if (cachedFirebaseUser) return {
			id: cachedFirebaseUser.uid,
			email: cachedFirebaseUser.email ?? "",
			user_metadata: {
				full_name: cachedFirebaseUser.displayName || cachedFirebaseUser.email?.split("@")[0] || "Membre",
				avatar_url: cachedFirebaseUser.photoURL ?? void 0
			},
			app_metadata: { provider: "firebase" },
			aud: "authenticated",
			created_at: cachedFirebaseUser.metadata.creationTime ?? (/* @__PURE__ */ new Date()).toISOString()
		};
		if (cachedSession?.user) return cachedSession.user;
		if (cachedLocalUser) return {
			id: cachedLocalUser.id,
			email: cachedLocalUser.email,
			user_metadata: { full_name: `${cachedLocalUser.prenom ?? ""} ${cachedLocalUser.nom ?? ""}`.trim() },
			app_metadata: {},
			aud: "authenticated",
...
var memoryCacheContacts = null;
var hasLoadedCloudContacts = false;
var contactListeners = /* @__PURE__ */ new Set();
function notifyContactChange(newItems) {
...
function useContacts() {
	...
	const [loading, setLoading] = (0, import_react.useState)(() => memoryCacheContacts === null || memoryCacheContacts.length === 0);
	(0, import_react.useEffect)(() => {
		const handleSync = (items) => {
			setContacts(items);
			setLoading(false);
		};
	...
	(0, import_react.useEffect)(() => {
		...
		if (!isCloudUser || !userId) {
			notifyContactChange(memoryCacheContacts ?? loadContactsLocal());
			setLoading(false);
			return;
		}
		...
		(async () => {
			try {
				...
				if (!cancelled) {
					...
					if (cloud.length > 0) notifyContactChange(cloud);
					else {
				...
				if (!cancelled) notifyContactChange(memoryCacheContacts ?? loadContactsLocal());
			} finally {
...
var NavRow = (0, import_react.memo)(function NavRow({ item, active, isCollapsed }) {
...
function AppShell({ title, subtitle, eyebrow, headerExtra, actions, onAdd, onSearch, searchValue, children }) {
	...
	const searchPersona = useRouterState({ select: (s) => s.location.search?.persona });
	const importState = useContactImport();
	const isItemActive = (item) => {
		if (!item.to) return false;
		if (item.to === "/assistant") {
			if (item.search?.persona) return pathname === "/assistant" && searchPersona === item.search.persona;
			return pathname === "/assistant" && (!searchPersona || searchPersona === "general_advisor");
		}
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				"aria-hidden": "true",
				children: [
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute -top-32 left-[12%] h-[500px] w-[550px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(79,70,229,0.12)_0%,transparent_70%)]" }, void 0, false, {
						fileName: _jsxFileName$6,
						lineNumber: 290,
						columnNumber: 11
					}, this),
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute top-[22%] -right-24 h-[560px] w-[560px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(216,26,69,0.08)_0%,transparent_70%)]" }, void 0, false, {
						fileName: _jsxFileName$6,
						lineNumber: 291,
						columnNumber: 11
					}, this),
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute top-[58%] left-[4%] h-[520px] w-[520px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(14,165,233,0.08)_0%,transparent_70%)]" }, void 0, false, {
						fileName: _jsxFileName$6,
						lineNumber: 292,
						columnNumber: 11
					}, this),
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute -bottom-28 right-[22%] h-[480px] w-[480px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(147,51,234,0.08)_0%,transparent_70%)]" }, void 0, false, {
						fileName: _jsxFileName$6,
						lineNumber: 293,
						columnNumber: 11
					}, this)
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
					...
					className: cn("absolute inset-y-0 left-0 flex w-[85%] max-w-[300px] flex-col border-r border-white/12 bg-[#0c0f1d]/95 backdrop-blur-xl p-4 transition-transform duration-200 ease-out shadow-[0_24px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.2)]", menuOpen ? "translate-x-0" : "-translate-x-full"),
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("aside", {
				className: cn("fixed inset-y-0 left-0 z-40 hidden flex-col border-r border-white/12 bg-[#0c0f1d]/90 backdrop-blur-xl md:flex transition-[width] duration-200 shadow-[4px_0_35px_rgba(0,0,0,0.45),inset_-1px_0_0_rgba(255,255,255,0.06)]", isVisualCollapsed ? "w-[72px]" : "w-[254px]"),
				children: [
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
					className: "sticky top-0 z-30 border-b border-white/12 bg-[#060812]/85 backdrop-blur-xl shadow-[0_10px_35px_-5px_rgba(0,0,0,0.4),inset_0_-1px_0_0_rgba(255,255,255,0.06)]",
					children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/profil-cloud-BuRN1ITj.js
function toProfil(r) {
