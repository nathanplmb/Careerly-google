...
import { C as normaliserCvStructure, S as cvStructureEnTexte } from "./router-WcHZLW5p.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/match-run-r33f9orm.js
var Input = object({
	profil: string().min(1),
	offre: string().min(10)
});
