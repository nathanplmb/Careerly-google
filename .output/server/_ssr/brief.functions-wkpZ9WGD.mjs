...
//#region node_modules/.nitro/vite/services/ssr/assets/brief.functions-wkpZ9WGD.js
var Input = object({
	faits: string().min(1),
...
var genererBrief = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((data) => Input.parse(data)).handler(genererBrief_createServerFn_handler, async ({ data, context }) => {
	...
	const { genererBriefIA, MODELE_BRIEF } = await import("./brief.server-CGr6LBYN.mjs");
	return {
