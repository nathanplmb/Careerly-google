//#region node_modules/.nitro/vite/services/ssr/assets/ai-fallbacks-CDZFwBkU.js
...
function fallbackExtraireOffre(texte) {
	...
	const missionsTexte = missions.slice(0, 5).map((m) => `• ${m}`).join("\n");
	const profilTexte = profil.slice(0, 5).map((p) => `• ${p}`).join("\n");
	const modalitesParts = [];
...
//#endregion
export { fallbackGenererInterview as a, fallbackGenererRelance as c, fallbackGenererBrief as i, nettoyerLigneBruitWeb as l, fallbackAnalyserCv as n, fallbackGenererLettre as o, fallbackExtraireOffre as r, fallbackGenererLinkedin as s, fallbackAnalyserCorrespondance as t };
