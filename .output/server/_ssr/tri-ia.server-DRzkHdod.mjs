...
import { f as fallbackTrierTexte, n as appelerGeminiSecurise, r as extraireJsonPropre } from "./ai-fallbacks-D-Yjb_jc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/tri-ia.server-DRzkHdod.js
object({
	resume: string(),
