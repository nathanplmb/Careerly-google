...
import { n as appelerGeminiSecurise, o as fallbackExtraireOffre, p as nettoyerLigneBruitWeb, r as extraireJsonPropre } from "./ai-fallbacks-D-Yjb_jc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/extraction.server-CvIGq-pK.js
object({
	entreprise: string(),
	poste: string(),
	lieu: string(),
