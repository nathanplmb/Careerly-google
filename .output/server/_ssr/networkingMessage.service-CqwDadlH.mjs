import { n as GenerateNetworkingMessageResultZodSchema } from "./networkingMessage.schema-Bl0tYGQq.mjs";
import { n as extraireJsonPropre, t as appelerGeminiSecurise } from "./gemini.server-D450yT_j.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/networkingMessage.service-CqwDadlH.js
var NETWORKING_MESSAGE_SYSTEM_PROMPT = `
...
`;
function buildNetworkingMessageUserPrompt(input) {
...
async function generateNetworkingMessageIA(input) {
...
//#endregion
export { generateNetworkingMessageIA };
