...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dbxbf-LE.mjs");
...
var manifest = {
	...
	"f31cec66ab6270632e857c072556e946de1cb08cff5fad1e7ad30363aeb8101e": {
		...
		importer: () => import("./cv.functions-BOf087SZ.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-AVT1AZP0.mjs").then((n) => n.t),
		import("./start-CeAMBUnY.mjs"),
