...
import { R as emptyCandidature, V as getNextBestAction, d as Textarea, dt as Button, p as Input } from "./router-Dma1Qf70.mjs";
...
import { t as UsageIaCard } from "./UsageIaCard-DnhPkFYB.mjs";
import { t as Badge } from "./profil-completion-Bp54MqOb.mjs";
...
import { c as texteErreurIA, n as lancerAnalyse, s as profilEnTexte } from "./match-run-CFvAPahz.mjs";
import { n as analyserOffre, t as CandidatureSheet } from "./CandidatureSheet-Bp5wFfkA.mjs";
import { n as extraireTexteFichier } from "./cv-fichier-BFa0B9CM.mjs";
import { n as genererLettre, r as genererLinkedin, t as genererInterview } from "./redaction.functions-Ceh_fGWA.mjs";
import { i as AccordionTrigger, n as AccordionContent, r as AccordionItem, t as Accordion } from "./accordion-BbWVrCDQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/assistant.index-BlsRGkXA.js
	...
	const ajouterAuxCandidatures = async () => {
		...
		try {
			const nouvelle = {
				...
				notes: `Importé via Careerly AI Hub le ${(/* @__PURE__ */ new Date()).toLocaleDateString("fr-FR")}`,
		...
		children: [
			...
			filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", {
						className: "mt-1 text-xs text-muted-foreground",
						children: search ? "Essayez une autre recherche ou créez une nouvelle opportunité." : "Ajoutez votre première opportunité pour utiliser toutes les capacités de Careerly AI."
					}, void 0, false, {
						fileName: _jsxFileName$1,
						lineNumber: 90,
						columnNumber: 11
