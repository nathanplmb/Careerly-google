			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CenterModal, {
				...
				children: selectedEntreprise && (() => {
					...
					return /* @__PURE__ */ (void 0)("div", {
						...
						children: [/* @__PURE__ */ (void 0)("div", {
							className: "flex flex-wrap items-center gap-x-6 gap-y-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 shadow-sm w-fit text-xs",
							children: [
								/* @__PURE__ */ (void 0)("div", {
									className: "flex items-center gap-2",
									children: [
