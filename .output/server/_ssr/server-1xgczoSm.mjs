...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DU7AN9Ka.mjs");
...
var manifest = {
	...
	"530dd75f0d23c73a9480aba6977b83b913b731251471b283785c5924115c2146": {
		...
		importer: () => import("./networkingMessage.server-fn-C2Ys0vSX.mjs")
	},
	"5dce3a03db727f995b2906f56c8fff4642a6524d3c785429cbac717e581b9048": {
		...
		importer: () => import("./contactImport.server-fn-BXG1LsLV.mjs")
	},
	"a8546a28c65e51fb3ecf9b7f6df5ff54e8d3e0bde77d5c2290b5d284fcc08ab9": {
		...
		importer: () => import("./opportunity.server-fn-PsjuVKjX.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-cEuEJGYQ.mjs").then((n) => n.t),
		import("./start-DSamYgP6.mjs"),
