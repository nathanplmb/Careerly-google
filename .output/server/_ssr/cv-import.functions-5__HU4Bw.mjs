...
import { t as createServerRpc } from "./createServerRpc-CUIQMIP9.mjs";
import { t as requireSupabaseAuth } from "./auth-middleware-CvXE0hiG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cv-import.functions-5__HU4Bw.js
...
var extraireCvServeur = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((data) => ImportCVInput.parse(data)).handler(extraireCvServeur_createServerFn_handler, async ({ data }) => {
	...
	const { parseAndExtractCV } = await import("./cvImport.service-DY1QMRPw.mjs");
