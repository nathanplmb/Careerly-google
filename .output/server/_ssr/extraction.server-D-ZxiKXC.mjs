...
import { n as appelerGeminiSecurise, r as extraireJsonPropre } from "./gemini.server-BnZeqvha.mjs";
import { l as nettoyerLigneBruitWeb, r as fallbackExtraireOffre } from "./ai-fallbacks-CDZFwBkU.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/extraction.server-D-ZxiKXC.js
object({
	entreprise: string(),
	poste: string(),
	lieu: string(),
