...
import { n as supabase } from "./client-DlNPIy5Y.mjs";
...
import { r as Textarea, s as Label } from "./createSsrRpc-JPKLwWjw.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CT0B1DVF.js
	...
	const inputData = (0, import_react.useMemo)(() => {
		return {
			...
			opportunities: items.map((c) => ({
				...
				contactNom: c.contact && !c.contact.includes("@") && !c.contact.startsWith("http") ? c.contact : void 0,
				contactEmail: c.contact && c.contact.includes("@") ? c.contact : void 0,
