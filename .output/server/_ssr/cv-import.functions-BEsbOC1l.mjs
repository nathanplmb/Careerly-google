...
//#region node_modules/.nitro/vite/services/ssr/assets/cv-import.functions-BEsbOC1l.js
...
var extraireCvServeur = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((data) => ImportCVInput.parse(data)).handler(extraireCvServeur_createServerFn_handler, async ({ data, context }) => {
	...
	const { extraireContenuCVServer } = await import("./extractor.server-BkYaLCVh.mjs");
	const { validateCVImportResult } = await import("./validator-BnpUTnK-.mjs");
