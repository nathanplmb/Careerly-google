...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-f9Q7ceSW.mjs");
...
var manifest = {
	"083602d0b411f735d2eebc83b88e78ffbf195fe1ecbd8d102e008b00ba40a90e": {
		...
		importer: () => import("./relance.functions-DMmoRTlg.mjs")
	},
	...
	"f31cec66ab6270632e857c072556e946de1cb08cff5fad1e7ad30363aeb8101e": {
		...
		importer: () => import("./cv.functions-mXQjX9-9.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-arR9ITmX.mjs").then((n) => n.t),
		import("./start-iVIMvhBA.mjs"),
