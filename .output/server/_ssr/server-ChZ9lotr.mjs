...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-ChZ9lotr.js
var server_ChZ9lotr_exports = /* @__PURE__ */ __exportAll({
	a: () => getServerFnById,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BF1qBrEz.mjs");
...
var manifest = {
	"083602d0b411f735d2eebc83b88e78ffbf195fe1ecbd8d102e008b00ba40a90e": {
		...
		importer: () => import("./relance.functions-CiBtjcJl.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DNaWCfYI.mjs").then((n) => n.t),
		import("./start-CZI-bh-2.mjs"),
...
//#endregion
export { getServerFnById as a, getRequest as i, createCsrfMiddleware as n, server_ChZ9lotr_exports as o, createServerFn as r, createMiddleware as s, TSS_SERVER_FUNCTION as t };
