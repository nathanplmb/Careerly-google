...
export function ProfilOverviewTab({ profil, bilan, onNavigate }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card/60 relative overflow-hidden p-6 sm:p-7 space-y-5">
      ...
      {bilan.suggestions.length > 0 && (
        <div className="rounded-2xl border border-border/60 bg-card/40 p-5 sm:p-6 space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
            <TrendingUp className="size-4 text-muted-foreground/80" />
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {bilan.suggestions.map((sug) => (
              ...
              >
                ...
                <div className="flex items-center gap-1 text-[11px] font-semibold text-muted-foreground group-hover:text-foreground transition-all group-hover:translate-x-1 duration-150">
