...
import { n as supabase } from "./_ssr/client-DlNPIy5Y.mjs";
import { r as Route$8 } from "./_ssr/router-CeQVKm6O.mjs";
import { N as Button } from "./_ssr/router-CeQVKm6O2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_._lovable.oauth.consent-6Z-R51EK.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var _jsxFileName = "/app/applet/src/routes/[.]lovable.oauth.consent.tsx?tsr-split=component";
function Consent() {
	const details = Route$8.useLoaderData();
	const { authorization_id } = Route$8.useSearch();
