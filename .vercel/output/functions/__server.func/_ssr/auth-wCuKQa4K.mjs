...
import { D as RefreshCw, H as Lock, Jt as ArrowLeft, Ot as CircleCheck, Pt as Check, U as LoaderCircle, Z as KeyRound, b as ShieldCheck, ct as FingerprintPattern, ft as Eye, g as Sparkles, it as Globe, m as Trash2, o as User, pt as EyeOff, rt as GraduationCap, t as Zap, u as UserCheck, xt as Copy, z as Mail } from "../_libs/lucide-react.mjs";
...
import { a as DialogHeader, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-GF5R-Jcs.mjs";
import { n as Route$21 } from "./router-D-SxcmZd.mjs";
import { C as isFirebaseConfigured, F as setCompteActif, G as Button, I as simulerConnexionDemo, L as supprimerCompteEnregistre, N as reinitialiserMotDePasseLocal, P as saveProfilLocal, S as inscrireUtilisateurLocal, W as Input, a as ensureUserProfilRegistered, c as Label, d as Logo, g as connecterUtilisateurLocal, i as Textarea, m as auth, w as loadProfil, x as getComptesEnregistres } from "./router-D-SxcmZd2.mjs";
import { t as motion } from "../_libs/motion.mjs";
import { n as genererCodeTransfert, t as appliquerCodeTransfert } from "./sync-transfert-CxT22oDj.mjs";
import { a as verifyBiometric, n as biometricSupported, t as biometricEnabled } from "./biometric-CT0UcaTm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-wCuKQa4K.js
...
function AuthPage() {
	...
	const handleSignIn = async (e) => {
		...
		if (isFirebaseConfigured()) try {
			...
			if (cred.user) ensureUserProfilRegistered({
				uid: cred.user.uid,
