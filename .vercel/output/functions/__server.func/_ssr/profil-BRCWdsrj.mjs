...
import { i as createServerFn } from "./server-BYSII4Hu.mjs";
import { A as Plus, At as ChevronUp, C as Search, Ct as CloudUpload, G as Linkedin, It as Calendar, J as LayoutDashboard, K as Link2, Kt as Award, M as Phone, Nt as ChevronDown, Ot as CircleCheck, Pt as Check, R as MapPin, St as Compass, T as Save, Tt as ClipboardType, U as LoaderCircle, Ut as Briefcase, Vt as Building, X as Languages, Y as Layers, _t as Earth, a as Users, at as Github, bt as Cpu, c as UserRound, dt as FileCode, et as Heart, f as TriangleAlert, ft as Eye, g as Sparkles, h as Target, it as Globe, kt as CircleAlert, lt as FileText, m as Trash2, mt as ExternalLink, n as X, p as TrendingUp, q as Lightbulb, qt as ArrowRight, r as Wrench, rt as GraduationCap, st as FolderDot, tt as HeartHandshake, vt as Download, xt as Copy, yt as DollarSign, z as Mail } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { h as string, m as object, p as number } from "../_libs/@lovable.dev/mcp-js+[...].mjs";
import { t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { A as nouvelleExperience, B as SelectContent, D as nouveauProjet, E as nouveauBenevolat, G as Button, H as SelectTrigger, M as nouvelleLangue, O as nouvelleCertification, P as saveProfilLocal, T as normaliserCvStructure, U as SelectValue, V as SelectItem, W as Input, _ as cvStructureEnTexte, c as Label, f as NIVEAUX_COMPETENCE, h as completionCv, i as Textarea, j as nouvelleFormation, k as nouvelleCompetence, l as AppShell, n as Badge, o as fetchProfil, p as NIVEAUX_LANGUE, q as cn, r as createSsrRpc, s as saveProfilCloud, u as useSession, w as loadProfil, y as emptyProfil, z as Select } from "./router-D-SxcmZd2.mjs";
import { t as requireSupabaseAuth } from "./auth-middleware-C7GNrPJv.mjs";
import { n as extraireTexteFichier } from "./cv-fichier-Dtp1f9pX.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/profil-BRCWdsrj.js
...
var _jsxFileName$18 = "/app/applet/src/components/ui/progress.tsx";
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [
			...
			showImporter && /* @__PURE__ */ (void 0)("div", {
				className: "glass-card p-6 border-purple-500/40 bg-card/95 shadow-xl relative animate-in fade-in slide-in-from-top-4",
				children: [/* @__PURE__ */ (void 0)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AppShell, {
		...
		children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("aside", {
				className: "w-full lg:w-64 shrink-0 flex flex-col gap-2",
				children: CATEGORIES.map((c) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
					onClick: () => handleSelectTab(c.id),
					className: `flex items-center justify-between p-3 rounded-lg border text-left transition-colors ${activeTab === c.id ? "bg-accent border-accent text-accent-foreground" : "bg-card border-border hover:bg-accent/50"}`,
					children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						className: "flex items-center gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
							className: `p-2 rounded-md ${c.colorClass}`,
							children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(c.icon, { className: "size-4" }, void 0, false, {
								fileName: _jsxFileName,
								lineNumber: 241,
								columnNumber: 19
							}, this)
						...
						lineNumber: 239,
						columnNumber: 15
					}, this), c.isComplete && /* @__PURE__ */ (void 0)(Check, { className: "size-4 text-emerald-500" }, void 0, false, {
						fileName: _jsxFileName,
						lineNumber: 250,
						columnNumber: 32
					}, this)]
				...
				className: "flex-1 glass-card p-6 min-h-[500px]",
				children: [
