...
import { n as createCsrfMiddleware, r as csrfSymbol } from "./server-WJa-_040.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrE_qO_-.mjs");
...
var manifest = {
	"47e694db27267631b2b10d89ba6fbeadb11f0a43861158b1191494d12c917b28": {
		...
		importer: () => import("./cv-import.functions-cR0TUqan.mjs")
	},
	"a8546a28c65e51fb3ecf9b7f6df5ff54e8d3e0bde77d5c2290b5d284fcc08ab9": {
		...
		importer: () => import("./opportunity.server-fn-BfFJERpg.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CeQVKm6O2.mjs").then((n) => n.t),
		import("./start-YXuckVf-.mjs"),
...
//#endregion
export { getRequest as a, server_exports as c, createServerFn as i, __exportAll as n, getServerFnById as o, createServerEntry as r, server_default as s, TSS_SERVER_FUNCTION as t };
